...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('zinnia_threaded_comments_threadedcomment', (
            ('comment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['comments.Comment'], unique=True, primary_key=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['zinnia_threaded_comments.ThreadedComment'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('zinnia_threaded_comments_threadedcomment')
    ...
    models = {
        ...
        'zinnia_threaded_comments.threadedcomment': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['zinnia_threaded_comments.ThreadedComment']"}),
